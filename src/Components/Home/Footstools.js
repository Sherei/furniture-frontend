        ...
        <div className='container-fluid px-lg-5 px-sm-4 my-5'>
            <div className='row'>
                <div className='col-lg-12 col-sm-12 my-2 d-flex justify-content-between align-items-center hero_main'>
                    <div>
                        <p className='fw-bolder fs-5' style={{ color: 'rgb(2, 2, 94)' }} >Footstools</p>
                    </div>
                    <div>
                        <a href="/Products/footstools">
                            <p className='view'>
                                View All
                            </p>
                        </a>
                ...
                <div className='col-lg-12 col-sm-12' style={{ position: "relative" }}>
                    <div className='h_box_main' ref={containerRef}>
                        {data.filter((item) => item.category === "footstools" && item.stock === undefined)
                            .map((product, index) => (
                    ...
                    {(data?.filter(product => product.category === "footstools" && product.stock === undefined).length === 0 || loading) && (
