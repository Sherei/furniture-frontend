    ...
    return <>
        <div className='container-fluid p-0'>
            <div className='row p-0'>
                <div className='col-lg-6 col-sm-12 p-0 vh-100 about_img' >
                    <img src="/about.jpg" alt="No Network" className='img-fluid' style={{height:"100%"}} />
                    
                </div>
                <div className='col-lg-6 col-md-12 col-sm-12 px-5 py-5 m-vh-100 d-flex align-items-center justify-content-center' style={{ backgroundColor: "rgb(2, 2, 94)" }}>
                    <div className='row '>
