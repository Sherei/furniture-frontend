    ...
    return <>
        <div className='container-fluid p-0' id='about'>
            <div className='row p-0'>
                ...
                <div className='col-lg-6 col-md-12 col-sm-12 px-lg-5 px-4 py-5 d-flex align-items-center 
                justify-content-center min-vh-100 ' style={{ backgroundColor: "rgb(2, 2, 94)" }}>
                    <div className='row '>
                        <div className='col-lg-10 col-md-10 col-sm-12'>
                            <p className='fs-1 fw-bolder' style={{ color: "#F7EEDD" }}> The House of Luxury <br/> Sofa Beds </p>
