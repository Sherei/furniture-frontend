        ...
        <div className="row">
          ...
          <div className="col-lg-5 col-sm-12 order-3" style={{ position: "relative" }}>
            ...
            <div className="mt-3  d-flex flex-wrap gap-3">
              ...
              <p className="m-0 fs-6 d-flex justify-content-center align-items-center cursor" onClick={() => handleShare("general")} style={{ width: "30px", height: "30px", backgroundColor: "#FAFAF9", borderRadius: "100%" }}><FaShareSquare /></p>
