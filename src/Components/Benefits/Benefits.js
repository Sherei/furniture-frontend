            ...
            <div className='row'>
                <div className='col-lg-12 col-sm-12 my-5'>
                    <div className='my-4 text-center'>
                        <h1 className='fw-bolder' style={{ color: "rgb(2, 2, 94)" }}>100% Satisfaction is Guaranteed</h1>
                    ...
                    <div className='benefit_main_box mt-5 px-lg-5 px-sm-0 gap-5'>
                        <div className='benefit_box'>
                            ...
                            <div><p className='text-center' style={{ fontSize: "20px", fontWeight: "600", color: "rgb(2, 2, 94)" }}>12 Months Warranty</p></div>
                        ...
                        <div className='benefit_box'>
                            ...
                            <div><p className='text-center' style={{ fontSize: "20px", fontWeight: "600", color: "rgb(2, 2, 94)" }}>Flexible Payments</p></div>
